/********************************************************************************
** Form generated from reading UI file 'popup_GLDZM.ui'
**
...
#ifndef UI_POPUP_GLDZM_H
#define UI_POPUP_GLDZM_H
...
public:
    ...
    void setupUi(QDialog *popup_GLDZM)
    {
        if (popup_GLDZM->objectName().isEmpty())
            popup_GLDZM->setObjectName(QStringLiteral("popup_GLDZM"));
        popup_GLDZM->resize(440, 770);
        QSizePolicy sizePolicy(QSizePolicy::Preferred, QSizePolicy::Preferred);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(popup_GLDZM->sizePolicy().hasHeightForWidth());
        popup_GLDZM->setSizePolicy(sizePolicy);
        buttonBox = new QDialogButtonBox(popup_GLDZM);
        buttonBox->setObjectName(QStringLiteral("buttonBox"));
        buttonBox->setGeometry(QRect(270, 730, 151, 32));
        buttonBox->setOrientation(Qt::Horizontal);
        buttonBox->setStandardButtons(QDialogButtonBox::Cancel|QDialogButtonBox::Ok);
        buttonBox->setCenterButtons(false);
        groupBox_Features = new QGroupBox(popup_GLDZM);
        ...
        groupBox_Bins = new QGroupBox(popup_GLDZM);
        ...
        retranslateUi(popup_GLDZM);
        QObject::connect(buttonBox, SIGNAL(accepted()), popup_GLDZM, SLOT(accept()));
        QObject::connect(buttonBox, SIGNAL(rejected()), popup_GLDZM, SLOT(reject()));

        QMetaObject::connectSlotsByName(popup_GLDZM);
    } // setupUi

    void retranslateUi(QDialog *popup_GLDZM)
    {
        ...
        comboBox_nBins->insertItems(0, QStringList()
         << QApplication::translate("popup_GLDZM", "8", Q_NULLPTR)
         << QApplication::translate("popup_GLDZM", "16", Q_NULLPTR)
         << QApplication::translate("popup_GLDZM", "32", Q_NULLPTR)
         << QApplication::translate("popup_GLDZM", "64", Q_NULLPTR)
        );
        comboBox_nBins->setCurrentText(QApplication::translate("popup_GLDZM", "8", Q_NULLPTR));
        radioButton_FBN->setText(QApplication::translate("popup_GLDZM", "Fixed Bin Number (FBN)      ", Q_NULLPTR));
        radioButton_FBS->setText(QApplication::translate("popup_GLDZM", "Fixed Bin Size (FBS)", Q_NULLPTR));
    } // retranslateUi

};

namespace Ui {
    class popup_GLDZM: public Ui_popup_GLDZM {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_POPUP_GLDZM_H
