...
struct qt_meta_stringdata_CImage_t {
    QByteArrayData data[1];
    char stringdata0[7];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CImage_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CImage_t qt_meta_stringdata_CImage = {
    {
QT_MOC_LITERAL(0, 0, 6) // "CImage"
...
const QMetaObject CImage::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CImage.data,
      qt_meta_data_CImage,  qt_static_metacall, nullptr, nullptr}
};
...
void *CImage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CImage.stringdata0))
