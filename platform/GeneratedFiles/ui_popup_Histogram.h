...
public:
    ...
    void setupUi(QDialog *popup_Histogram)
    {
        ...
        popup_Histogram->resize(400, 680);
        ...
        groupBox_Features->setGeometry(QRect(20, 30, 361, 491));
        ...
        gridLayout->addWidget(checkBox_Range, 7, 1, 1, 1);
        ...
        gridLayout->addWidget(checkBox_CoeffOfVar, 9, 1, 1, 1);
        ...
        gridLayout->addWidget(checkBox_Mean, 0, 0, 1, 1);
        ...
        gridLayout->addWidget(checkBox_Kurtosis, 1, 1, 1, 1);
        ...
        gridLayout->addWidget(checkBox_Variance, 0, 1, 1, 1);
        ...
        gridLayout->addWidget(checkBox_RobustMeanAbsDev, 8, 1, 1, 1);
        ...
        gridLayout->addWidget(checkBox_MaxHisGradient, 11, 1, 1, 1);
        ...
        gridLayout->addWidget(checkBox_MinHistGradGrey, 13, 0, 1, 1);
        ...
        gridLayout->addWidget(checkBox_90thPercentile, 5, 1, 1, 1);
        ...
        gridLayout->addWidget(checkBox_Minimum, 4, 1, 1, 1);
        ...
        gridLayout->addWidget(checkBox_Maximum, 6, 0, 1, 1);
        ...
        gridLayout->addWidget(checkBox_InterquartileRange, 6, 1, 1, 1);
        ...
        gridLayout->addWidget(checkBox_Mode, 7, 0, 1, 1);
        ...
        gridLayout->addWidget(checkBox_10thPercentile, 5, 0, 1, 1);
        ...
        gridLayout->addWidget(checkBox_Skewness, 1, 0, 1, 1);
        ...
        gridLayout->addWidget(checkBox_Median, 4, 0, 1, 1);
        ...
        gridLayout->addWidget(checkBox_MedianAbsDev, 9, 0, 1, 1);
        ...
        gridLayout->addWidget(checkBox_QuartileCoeff, 10, 0, 1, 1);
        ...
        gridLayout->addWidget(checkBox_Entropy, 10, 1, 1, 1);
        ...
        gridLayout->addWidget(checkBox_Uniformity, 11, 0, 1, 1);
        ...
        gridLayout->addWidget(checkBox_MaxHistGradGrey, 12, 0, 1, 1);
        ...
        gridLayout->addWidget(checkBox_MinHistGradient, 12, 1, 1, 1);
        ...
        gridLayout->addWidget(checkBox_MeanAbsDev, 8, 0, 1, 1);

        gridLayoutWidget = new QWidget(popup_Histogram);
        gridLayoutWidget->setObjectName(QStringLiteral("gridLayoutWidget"));
        gridLayoutWidget->setGeometry(QRect(20, 540, 361, 51));
