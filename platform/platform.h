...
public:	
	enum FAMILY { E_MORPHOLOGY, E_LOCALINTENSE, E_INTENSESTAT, E_INTENSEHISTO, E_GLCM, E_GLRLM, E_GLSZM, E_GLDZM, E_NGTDM, E_NGLDM, FAMILY_COUNT };
